    ...
    public partial class seeddata : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2020, 3, 8, 11, 59, 0, 393, DateTimeKind.Local).AddTicks(250), 1, "John Doe", 1, 2, 0.25, 1.0 });

            migrationBuilder.InsertData(
                table: "PurchaseOrders",
                columns: new[] { "Id", "Datetime", "InventoryItemId", "NameOfBuyer", "PaymentTypeId", "Quantity", "SalesTax", "Subtotal" },
                values: new object[] { 2, new DateTime(2020, 3, 7, 11, 59, 0, 393, DateTimeKind.Local).AddTicks(3510), 3, "Mildred Smith", 3, 4, 4.5, 18.0 });
        }
